package com.example.musiccleanarchitecture.app.util.clean
...
/**
 * Executes the received [fn] function if the Either value is Left. Do nothing in other case.
...
/**
 * Executes the received [fn] function if the Either value is Right. Do nothing in other case.
 * Returns the current Either value after these.
 */
...
/**
 * Executes the received [fn] function even if the Either value is Right or Left.
 * Returns the current Either value after these.
 */
suspend fun <L, R> Either<L, R>.finally(fn: suspend () -> Unit): Either<L, R> {
    fn()
    return this
}
